...
dicCategoria = {} #instanciar uma variavel do tipo dicionario 

if os.path.isfile(arquivo):#verifica se o caminho do arquivo é valido 
    for line in categorias: #para cada linha do arquivo
        colunas = line.strip().split(';')#retira os espaços e separa em lista as colunas
        dados =[colunas[1], colunas[2]]#armazena em dados uma lista com os valores da coluna 1 e 2 
        dicCategoria[colunas[0]] = dados #cria uma chave com o valor da coluna 0 e associa o valor com os dados
