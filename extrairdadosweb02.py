...
html_soup = BeautifulSoup(response.text, 'html.parser') #parser combinação de HTML para texto
filme = html_soup.find_all('div', class_='lister-item mode-advanced')
print(len(filme))

for indice in range(10):
    filme_dados = filme[indice]
